        ...
        ScrollView {
            VStack(spacing: 10) {
                ...
                TextField("Username", text: $createAccountViewModel.username)
                    ...
                    .accessibilityIdentifier("CAUsernameTextField")
                SecureField("Password", text: $createAccountViewModel.password)
                    .padding(.horizontal)
                    .frame(height: 55)
                    .overlay(RoundedRectangle(cornerRadius: 10).stroke(Color.black))
                    .accessibilityIdentifier("CAPasswordSecureField")
                SecureField("Repeat password", text: $createAccountViewModel.repeatPassword)
                    .padding(.horizontal)
                    .frame(height: 55)
                    .overlay(RoundedRectangle(cornerRadius: 10).stroke(Color.black))
                    .accessibilityIdentifier("CARepeatPasswordSecureField")
            }
            .padding(15)
            ...
            VStack {
                Button(action: createAccountButtonPressed) {
                    Text("Create".uppercased())
                        ...
                        .cornerRadius(10)
                        .accessibilityIdentifier("CACreateButton")
                }
                Button(action: cancelButtonPressed) {
                    Text("Cancel")
                        .bold()
                        .accessibilityIdentifier("CACancelButton")
                }
            }
            .padding(15)
